module.exports = function(grunt) {
    ...
    .browserstackTask("browserstack-desktop-removal-es-betajs-shims", 'tests/tests-removal-es-betajs-shims.html', {desktop: true, mobile: false})
    ...
    .browserstackTask("browserstack-mobile-removal-es-betajs-shims", 'tests/tests-removal-es-betajs-shims.html', {desktop: false, mobile: true})
